    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" id="date_of_operation" name="date_of_operation" placeholder="YYYY-MM-DD"
                value="<?php echo date("Y-m-d"); ?>" type="text" required>
        </div>
        <div class="col-md-6">
            <!-- Date input -->
            <label class="form-label" for="date">วันที่แล้วเสร็จ</label>
            <input class="form-control" id="date_completion" name="date_completion" placeholder="YYYY-MM-DD"
                value="<?php echo date("Y-m-d"); ?>" type="text" required>
        </div>

        <div class="col-md-6 mt-2">
            <label for="problems_found" class="form-label">ปัญหาที่พบ</label>
            <textarea class="form-control" id="problems_found" name="problems_found" rows="2" required></textarea>
        </div>
        ...
        <div class="col-md-6 mt-2">
            ...
            <textarea class="form-control" id="spare_part" name="spare_part" rows="2" required></textarea>
        ...
        <div class="col-md-6 mt-2">
            <?php                                                                  
                $select_status = $conn->query("SELECT * FROM tbl_status Where sid >=3  and sid <=5");
