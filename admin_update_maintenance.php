                ...
                <form id="myform1" name="form1" method="post" class="row g-3" action=db_general.php validate>
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <a href="admin_update_maintenance" class="btn btn-secondary">กลับ</a>
                                    ...
                                    <table id="myTable" class="display" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <button type="button" class="btn btn-primary edit_data" data-toggle="modal"
                                                    id="<?php echo $row["case_id"]; ?>"
